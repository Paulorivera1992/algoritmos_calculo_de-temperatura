...
def Tf(ruta,logger):
  try:
    completed = subprocess.run(['./calculo_Tf',ruta], check=True, cwd="/home/ubuntu/rasberry/Algoritmos_C/") 
...
def crear_archivos_de_datos():
  f=open("/home/ubuntu/rasberry/Algoritmos_C/archivos_temperatura/Tf_direct.txt","w")
  f.close()
  f=open("/home/ubuntu/rasberry/Algoritmos_C/archivos_temperatura/Tf_rec_spect.txt","w")
  f.close()