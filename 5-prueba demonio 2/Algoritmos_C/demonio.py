...
class App():
   ...
   def run(self):
      ...
      ip=Funciones_Tf.cargar_ip('/home/ubuntu/rasberry/Algoritmos_C/configuracion.txt')
      puerto=Funciones_Tf.cargar_puerto('/home/ubuntu/rasberry/Algoritmos_C/configuracion.txt')
      Funciones_Tf.comprobar_ip(ip,logger)
      servidor="opc.tcp://"+ip+":"+puerto  
      nombre_tf_direct=Funciones_Tf.cargar_nombre_tf_direct('/home/ubuntu/rasberry/Algoritmos_C/configuracion.txt')
      nombre_tf_rec_spect=Funciones_Tf.cargar_nombre_tf_rec_spect('/home/ubuntu/rasberry/Algoritmos_C/configuracion.txt')
      ...
      while True:
         ...
         Funciones_Tf.escribir_datos(servidor,'/home/ubuntu/rasberry/Algoritmos_C/archivos_temperatura/Tf_direct.txt',nombre_tf_direct,estatus,logger)  
         Funciones_Tf.escribir_datos(servidor,'/home/ubuntu/rasberry/Algoritmos_C/archivos_temperatura/Tf_rec_spect.txt',nombre_tf_rec_spect,estatus,logger) 
